      ...
      <NavLink
        ...
        className={({ isActive }) =>
          `flex justify-start items-center flex-row my-8 text-sm font-medium
               ${
                 isActive ? "text-textHover" : "text-text"
...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`absolute top-0 h-screen w-2/3 bg-gradient-to-tl from-white/10 to-[#483d8d] backdrop-blur-lg z-10 p-6 md:hidden transition-all duration-300 ease-in-out ${
