...
const RecentlyAddedCard = ({ song, i, isPlaying, activeSong, handlePauseClick, handlePlayClick }) => {
   return (
      <div className="w-full flex flex-row items-center hover:bg-bgHover py-2 p-4 rounded-lg cursor-pointer mb-2">
         ...
         <div className="flex-1 flex flex-row justify-between items-center">
            <img className="w-20 h-20 rounded-lg " src={song?.coverImage || logo} alt="song_img" onError={(e) => {
...
const RecentlyAdded = () => {
   ...
   return (
      <div ref={divRef} className="xl:ml-6 ml-0 xl:mb-0 mb-6 flex-1 md:max-w-[400px] max-w-full flex flex-col">
